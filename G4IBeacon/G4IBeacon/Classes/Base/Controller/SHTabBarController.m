...
- (void)addChildControllers {
    ...
    [self setUpChildController:[[UIStoryboard storyboardWithName:NSStringFromClass([SHAllViewController class]) bundle:nil] instantiateInitialViewController]  title:@"All" imageName:@"All" highlightedImageName:@"All_highlighted"];
}
